...
class UpdateCondicionLaboralRequest extends FormRequest
{
    ...
    public function toDTO(): UpdateCondicionLaboralDTO
    {
        return UpdateCondicionLaboralDTO::from($this->validated());
    }
}
